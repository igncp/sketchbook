...
diagrams.graph([
  ...
  n("HTML5Backend", [2,
    ...
    ct(0, 'Checks if it is not Firefox. If it is, it does not call the hover action, as in that case is covered in the dragover event.'),
    ...
    ct(5, 'Used for the method isDraggingNativeItem, which retrieves the itemType from the monitor, and compares it to the native types.'),
  ], "/HTML5Backend.js"),
