...
diagrams.box({
  ...
  body: [c('src', [
    ...
    c('di', [
      ...
      c('injector.ts', [
        "const undefinedValue = CONST_EXPR(new Object());",
        "const PUBLIC = 1;",
        "const PRIVATE = 2;",
        "const PUBLIC_AND_PRIVATE = 3;",
        c('interface ProtoInjectorStrategy', [
          "getBindingAtIndex(index: number): ResolvedBinding;",
          "createInjectorStrategy(inj: Injector): InjectorStrategy;",
        ]),
        c('class ProtoInjectorInlineStrategy implements ProtoInjectorStrategy', [
        ...
        c('class ProtoInjectorDynamicStrategy implements ProtoInjectorStrategy', [
        ...
        c('class ProtoInjector', [
          "_strategy: ProtoInjectorStrategy;",
          "constructor(bwv: BindingWithVisibility[])",
          "getBindingAtIndex(index: number): any",
        ]),
        c('interface InjectorStrategy', [
        ...
        c('class InjectorInlineStrategy implements InjectorStrategy', [
          "attach(parent: Injector, isBoundary: boolean): void",
        ...
        c('class InjectorDynamicStrategy implements InjectorStrategy', [
          "attach(parent: Injector, isBoundary: boolean): void",
        ...
        c('class Injector', "A dependency injection container used for resolving dependencies. An `Injector` is a replacement for a `new` operator, which can automatically resolve the constructor dependencies. In typical use, application code asks for the dependencies in the constructor and they are resolved by the `Injector`.", [
          ...
          "constructor(public _proto: ProtoInjector, public _parent: Injector = null, private _depProvider: DependencyProvider = null)",
          "private _getByDependency(binding: ResolvedBinding, dep: Dependency, bindingVisibility: number): any",
          "private _getByKey(key: Key, depVisibility: VisibilityMetadata, optional: boolean, bindingVisibility: number): any",
          d("createChildFromResolved(bindings: List<ResolvedBinding>, depProvider: DependencyProvider = null): Injector", "Creates a child injector and loads a new set of ResolvedBindings into it."),
          d("get internalStrategy(): any", "Internal. Do not use. We return `any` not to export the InjectorStrategy type."),
          d("get parent(): Injector", "Direct parent of this injector."),
          d("get(token: any): any", "Retrieves an instance from the injector."),
          d("getAt(index: number): any", "Retrieves an instance from the injector."),
          d("getOptional(token: any): any", "Retrieves an instance from the injector."),
          d("resolveAndCreateChild(bindings: List<Type | Binding | List<any>>, depProvider: DependencyProvider = null): Injector", "Creates a child injector and loads a new set of bindings into it. A resolution is a process of flattening multiple nested lists and converting individual bindings into a list of ResolvedBindings. The resolution can be cached by `resolve` for the Injector for performance-sensitive code."),
          d("static fromResolvedBindings(bindings: List<ResolvedBinding>, depProvider: DependencyProvider = null): Injector", "Creates an injector from previously resolved bindings. This bypasses resolution and flattening. This API is the recommended way to construct injectors in performance-sensitive parts."),
          d("static resolve(bindings: List<Type | Binding | List<any>>): List<ResolvedBinding>", "Turns a list of binding definitions into an internal resolved list of resolved bindings. A resolution is a process of flattening multiple nested lists and converting individual bindings into a list of ResolvedBindings. The resolution can be cached by `resolve` for the Injector for performance-sensitive code."),
      ...
      c('key.ts', [
        ...
        c('class Key', "A unique object used for retrieving items from the Injector. Keys have: - a system-wide unique `id`. - a `token`, usually the `Type` of the instance. Keys are used internally by the Injector because their system-wide unique `id`s allow the injector to index in arrays rather than looking up items in maps.", [
          ...
          "get displayName(): string",
          d("static get numberOfKeys(): number", "@returns the number of keys registered in the system.  "),
          d("static get(token: Object): Key", "Retrieves a `Key` for a token."),
        ]),
        c('class KeyRegistry', [
      ...
      c('metadata.ts', [
        ...
        c('class OptionalMetadata', "@CONST(); A parameter metadata that marks a dependency as optional. Injector provides `null` if the dependency is not found.", [
          "toString(): string",
        ]),
        c('class DependencyMetadata', "@CONST(); `DependencyMetadata is used by the framework to extend DI. Only metadata implementing `DependencyMetadata` are added to the list of dependency properties.", [
          "get token()",
        ]),
        c('class InjectableMetadata', "@CONST(); A marker metadata that marks a class as available to `Injector` for creation. Used by tooling for generating constructor stubs.", [
          "constructor()",
        ]),
        c('class VisibilityMetadata', "@CONST(); Specifies how injector should resolve a dependency.", [
          "constructor(public crossBoundaries: boolean, public _includeSelf: boolean)",
          "get includeSelf(): boolean",
          "toString(): string",
        ]),
        c('class SelfMetadata extends VisibilityMetadata', "@CONST(); Specifies that an injector should retrieve a dependency from itself.", [
          "constructor()",
          "toString(): string",
        ]),
        c('class AncestorMetadata extends VisibilityMetadata', "@CONST(); Specifies that an injector should retrieve a dependency from any ancestor from the same boundary.", [
          "constructor({self}: {self?: boolean} = {})",
          "toString(): string",
        ]),
        c('class UnboundedMetadata extends VisibilityMetadata', "@CONST(); Specifies that an injector should retrieve a dependency from any ancestor, crossing boundaries.", [
          "constructor({self}: {self?: boolean} = {})",
          "toString(): string",
        ]),
