...
diagrams.graph([
  n("AtRule", [0, ctde(2), ct(22, "To deprecate methods")], "AtRule(defaults)"),
  n("Comment", [1, ct(22, "To deprecate methods"), ctde(9)], "Comment(defaults)"),
  n("Container", [2, ct([1, 4, 17], "#normalize and #rebuild"), ctde(9)], "Container[Constructor inherited]"),
  n("CssSyntaxError", [3, ct(22, "To deprecate methods")], "CssSyntaxError(message, line, column, source, file, plugin)"),
  n("Declaration", [4, ct(22, "To deprecate methods"), ctde(9)], "Declaration(defaults)"),
  ...
  n("parse", [10, 11, 5], "parse(css, opts)", "s-t"),
  ...
  n("Root", [16, ctde(2), ct(22, "To deprecate methods")], "Root(defaults)"),
  n("Rule", [17, ctde(2), ct(22, "To deprecate methods"), ct(7, "#get selectors")], "Rule(defaults)"),
  n("Stringifier", [18], "Stringifier(builder)"),
  n("stringify", [19, 18], "stringify(node, builder)", "s-t"),
  n("tokenize", [20], "tokenize(input)", "s-t"),
  n("vendor", [21], "vendor", "s-t"),
  n("warn-once", [22], "warn-once(message)", "s-t"),
